export default function Home() {
  return (
    <>
      {/* HERO */}
      <section className="relative section overflow-hidden bg-gray-50">
        {/* Fondos decorativos */}
        <div
        ...
        <div className="relative container grid gap-8 md:grid-cols-2 items-center py-12">
      ...
      {/* LOGOS */}
      <section className="relative py-10 mt-auto">
        <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-[#c7d9f5] to-transparent" />
        <div className="container flex flex-wrap justify-center items-center gap-12 opacity-80">
          <img
